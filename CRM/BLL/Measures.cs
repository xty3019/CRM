...
namespace Maticsoft.BLL
{
	...
	public partial class Measures
	{
		...
		{
			return dal.DeleteList(MeIDlist );
		}
		...
		public Maticsoft.Model.Measures GetModel(int MeID)
		{
			...
			return dal.GetModel(MeID);
		}

		/// <summary>
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Maticsoft.Model.Measures GetModelByCache(int MeID)
		{
			
			string CacheKey = "MeasuresModel-" + MeID;
			object objModel = Maticsoft.Common.DataCache.GetCache(CacheKey);
			if (objModel == null)
			{
				try
				{
					objModel = dal.GetModel(MeID);
					if (objModel != null)
					{
