...
namespace Maticsoft.DAL
{
	...
	public partial class Orders
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("OrderID", "Orders"); 
		}
		...
		public Maticsoft.Model.Orders GetModel(int OrderID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 OrderID,CusID,OrderDate from Orders ");
			strSql.Append(" where OrderID=@OrderID");
			SqlParameter[] parameters = {
					new SqlParameter("@OrderID", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select OrderID,CusID,OrderDate ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" OrderID,CusID,OrderDate ");
			strSql.Append(" FROM Orders ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
